...
export default function EmotionalGeometryAI() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-950 to-indigo-950">
      <div className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-950 via-slate-900 to-slate-800">
        {/* Background Pattern */}
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
          ...
          <div className="mb-12 flex justify-center">
            <div className="relative">
              ...
              <div className="absolute inset-0 animate-spin-slow">
                <div className="w-80 h-80 rounded-full border-2 border-dashed border-cyan-400/30"></div>
                <div className="absolute top-0 left-1/2 w-2 h-2 bg-cyan-400 rounded-full transform -translate-x-1/2 -translate-y-1"></div>
                <div className="absolute top-1/4 right-0 w-1.5 h-1.5 bg-cyan-300 rounded-full transform translate-x-1"></div>
                <div className="absolute bottom-1/4 right-0 w-1 h-1 bg-cyan-500 rounded-full transform translate-x-1"></div>
                <div className="absolute bottom-0 left-1/2 w-2 h-2 bg-cyan-400 rounded-full transform -translate-x-1/2 translate-y-1"></div>
                <div className="absolute bottom-1/4 left-0 w-1 h-1 bg-cyan-500 rounded-full transform -translate-x-1/2"></div>
                <div className="absolute top-1/4 left-0 w-1.5 h-1.5 bg-cyan-300 rounded-full transform -translate-x-1"></div>
              </div>

              {/* Main Logo */}
              <div className="w-80 h-80 flex items-center justify-center">
                <img
                  src="/images/vexaeg-clean-logo.png"
                  alt="VexaEG Geometric Logo"
          ...
          <div className="space-y-6 mb-12">
            <h1 className="text-6xl md:text-7xl font-bold bg-gradient-to-r from-cyan-400 via-purple-500 to-pink-500 bg-clip-text text-transparent">
              VexaEG
            </h1>
            <h2 className="text-3xl md:text-4xl font-semibold text-slate-200 mb-4">Emotional Geometry AI</h2>
            <p className="text-xl text-slate-400 max-w-2xl mx-auto leading-relaxed">
              Advanced emotional state analysis through geometric visualization and AI-powered insights
            </p>
          </div>
          ...
          <div className="flex justify-center">
            <Button
              ...
              className="bg-gradient-to-r from-cyan-500 via-purple-600 to-pink-600 hover:from-cyan-600 hover:via-purple-700 hover:to-pink-700 shadow-2xl shadow-cyan-500/25 text-white font-semibold px-12 py-4 text-lg rounded-2xl transform hover:scale-105 transition-all duration-300"
            >
              Begin Analysis
          ...
          <div className="container mx-auto px-6 py-8">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                <Image
                  src="/images/vexaeg-star-icon.png"
                  alt="VexaEG Logo"
                  width={48}
                  height={48}
                ...
                <Card className="bg-slate-800/30 border-slate-700/50 backdrop-blur-xl shadow-xl">
                  <CardContent className="p-16 text-center">
                    <div className="w-24 h-24 rounded-3xl bg-gradient-to-br from-slate-700 to-slate-800 flex items-center justify-center mx-auto mb-8">
                      <Image
                        src="/images/vexaeg-analysis-logo.png"
                        alt="VexaEG Analysis Logo"
                        width={96}
                        height={96}
                    ...
                    <p className="text-slate-400 text-lg leading-relaxed max-w-lg mx-auto">
                      Set your emotional levels and biometric data, then click "Run Analysis" to begin your
